...
image::./images/devconsoleapp3.png[image,300]
...
image::./images/devconsoleapp5.png[image,300]

* Now click on the URL icon on the top right

image::./images/devconsoleapp6.png[image,30, float="left"] 
...
image::./images/devconsoleapp8.png[image,300] 
